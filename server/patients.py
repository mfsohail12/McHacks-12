...
def generate_mock_queue_position(num_of_patients):
    category_position = random.randint(1, 5)
    global_position = random.randint(category_position, num_of_patients)
    return {
        'global': global_position,
        'category': category_position,
    }

def generate_mock_patient(num_of_patients, **kwargs):
    ...
    patient_data = {
        ...
        'queue_position': kwargs.get('queue_position', generate_mock_queue_position(num_of_patients)),
